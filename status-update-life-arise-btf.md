...
- [ ] Initialise a git repo in this folder and commit locally (in progress via Cline — see log)
- [ ] Push to a new GitHub repository (pause until the empty repo exists or `gh` auth is confirmed)
